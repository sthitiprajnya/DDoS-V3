...
The DDoS server which is used to perform DDoS attacks via coordinated attacks.
DDoS Clients/Bots can connect to the DDoS Server to receive the instructions.
"""
